...
import br.com.dio.hangman.execepition.GameIsFinishedException;
import br.com.dio.hangman.execepition.LetterAlreadyInputtedException;
...
public class HangmanGame {
    ...
    private final static int HANGMAN_LIFE_LINE_LENGTH = 9;
    private final static int HANGMAN_LIFE_LINE_LENGTH_WITH_LINE_SEPARATOR = 10;
    ...
    public HangmanGame(final List<HangmanChar> characters) {
        ...
        this.lineSize = HANGMAN_LIFE_LINE_LENGTH_WITH_LINE_SEPARATOR + whiteSpaces.length();
    ...
    private List<HangmanChar> setCharacterSpacesPositionInGame(final List<HangmanChar> characters, final int whiteSpacesAmount){
        ...
        for (int i = 0; i < characters.size(); i++) {
            characters.get(i).setPosition(this.lineSize * LINE_LETTER + HANGMAN_LIFE_LINE_LENGTH + i);
        }
        return characters;
    }
